...
export declare class TransactionBuilder {
    ...
    addInput(txHash: Buffer | string | Transaction, vout: number, sequence?: number, prevOutScript?: Buffer, value?: bigint): number;
    addOutput(scriptPubKey: string | Buffer, value: bigint): number;
    build(): Transaction;
    buildIncomplete(): Transaction;
    sign(signParams: number | TxbSignArg, keyPair?: Signer, redeemScript?: Buffer, hashType?: number, witnessValue?: bigint, witnessScript?: Buffer, controlBlock?: Buffer, annex?: Buffer): void;
